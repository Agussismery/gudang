    ...
    public function index()
    {
        ...
        if ($this->input->post('submit', TRUE) == 'Submit') {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $data = [
                    'barcode_pengiriman' => $this->security->xss_clean($this->input->post('barcode', TRUE)),
                    // 'tgl_pengembalian' => $this->security->xss_clean($this->input->post('tgl_kirim', TRUE))
                ];
            ...
            $this->template->kasir('data_kembali/index', $data);
        }
    }
