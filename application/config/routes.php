...
$route['mutu_barang'] = 'data_mutu_barang/index';
$route['get_harga_barang'] = 'data_barang/get_harga_barang';
$route['ajax_mutu_barang'] = 'data_mutu_barang/ajax_mutu_barang';
$route['tambah_mutu_barang'] = 'data_mutu_barang/tambah_data';


$route['input_berat'] = 'data_berat/index';
$route['ajax_berat'] = 'data_berat/ajax_berat';
$route['get_item_detail'] = 'data_berat/get_item_detail';

$route['input_pengiriman'] = 'data_pengiriman/index';
$route['ajax_pengiriman'] = 'data_pengiriman/ajax_pengiriman';

$route['input_kembali'] = 'data_kembali/index';
$route['ajax_kembali'] = 'data_kembali/ajax_kembali';
