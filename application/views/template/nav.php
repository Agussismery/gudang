...
<nav id="sidebar">
    <div class="p-4 pt-5">
        ...
        <ul class="list-unstyled components mb-5">
            ...
            <li <?= (in_array(strtolower($this->uri->segment(1)), ['mutu_barang'])) ? 'class="active"' : ''; ?>>
                <a href="<?= site_url('mutu_barang'); ?>"><i class="fa fa-share"></i> Mutu Barang</a>
            </li>
            ...
            <li <?= (in_array(strtolower($this->uri->segment(1)), ['input_pengiriman'])) ? 'class="active"' : ''; ?>>
                <a href="<?= site_url('input_pengiriman'); ?>"><i class="fa fa-reply"></i> Data Pengiriman Barang</a>
            </li>
            <li <?= (in_array(strtolower($this->uri->segment(1)), ['input_kembali'])) ? 'class="active"' : ''; ?>>
                <a href="<?= site_url('input_kembali'); ?>"><i class="fa fa-reply"></i> Data Pengembalian Barang</a>
            </li>
