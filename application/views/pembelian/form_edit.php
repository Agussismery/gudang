...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-share"></i> Edit Data Mutu Barang</h4>
    </div>
</div>
<hr class="mt-0" />
<div id="message">
...
<div class="col-md-12">
    ...
    <div class="col-sm-4 offset-sm-8">
        ...
        <button type="button" onclick="window.location.replace('<?= site_url('mutu_barang'); ?>')" class="btn btn-light btn-sm">
            Kembali
        </button>
    </div>
</div>
