...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-share"></i> Tambah Data Mutu Barang</h4>
    </div>
</div>
<hr class="mt-0" />
<div id="message">
...
<div class="col-md-12">
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" id="id_pembelian" name="nama_teks" value="<?= $id_pembelian; ?>">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-2">
            <input type="text" class="form-control form-control-sm" id="nobal" placeholder="">
        </div>
    </div>
    <div class="form-group row">
        <label for="barangx" class="col-sm-2 col-form-label">Barang Barang</label>
        <div class="col-sm-6">
