...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-cubes"></i> Data Barang Kembali</h4>
    </div>
    ...
    <div class="col-md-12">
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                ...
                <select class="custom-select custom-select-sm barang-select" onchange="get_item_detail(this.value)" id="barcode" name="barcode">
                    <option value="" disabled selected>Pilih Noball</option>
                    <?php foreach ($data->result() as $d) : ?>
                        <option value="<?= $d->id; ?>">
                            <?= $d->barcode_pengiriman ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            </div>
